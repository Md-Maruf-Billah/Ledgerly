...
- MYOB and Xero: too complex, too many features, overwhelming for sole traders
- Generic to-do apps (Todoist, Things): not compliance-specific, no context
- SaaS dashboards with hero metrics and gradient stat blocks: feels like a product demo, not a working tool
- Navy-and-gold "finance" aesthetics: corporate, impersonal, trust-through-formality
- Red-alert compliance tools that lead with overdue warnings: amplifies anxiety instead of reducing it
...
5. **Invisible correctness.** Interactions should behave exactly as the user expects, requiring zero learning. The best feature is one the user doesn't notice because it just worked.
